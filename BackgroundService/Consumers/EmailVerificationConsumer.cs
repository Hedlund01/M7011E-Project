    ...
    : IConsumer<TwoFactorEmail>, IConsumer<EmailVerification>
{
    ...
    {
       await mailService.SendEmailAsync(context.Message.Email, $"Hi, your 2fa token is ${context.Message.Token}",
            "2fa token - M7011E");
    ...
    {
        await mailService.SendEmailAsync(context.Message.Email, $"Hi, your email verification token is ${context.Message.Token}",
